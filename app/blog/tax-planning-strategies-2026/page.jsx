...
import { taxPlanningStrategiesArticle as article } from "../posts";
...
export default function TaxPlanningStrategiesPage() {
  return (
    <main className="min-h-screen bg-[#f7f5ef] text-[#17201d]">
      ...
      <article>
        <section className="relative overflow-hidden bg-[#17201d] px-5 py-20 text-white sm:px-8">
          <Image
            src="/bram-hero.png"
            alt="Accounting documents and tax planning notes"
            fill
            priority
            sizes="100vw"
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
          <div className="max-w-3xl">
            <div className="border-l-4 border-[#c7a15a] bg-white px-5 py-5 text-sm leading-7 text-[#4f5c55] shadow-sm">
              This article is for general information. Tax rules can vary based on jurisdiction, entity structure, transaction type, and current law, so a professional review is recommended before taking action.
            </div>
          ...
          <aside className="h-fit border border-[#ddd3c0] bg-white p-6 shadow-sm lg:sticky lg:top-8">
            ...
            <p className="mt-4 text-sm leading-6 text-[#5b665f]">
              Get partner-reviewed support for tax planning, advisory, compliance reviews, deductions, credits, and year-round reporting.
            </p>
            <Link
              href="/contact"
